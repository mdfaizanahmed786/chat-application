...
const Navbar = (props: Props) => {
  ...
  <p className='font-bold text-lg text-white'>{messageContext?.messages?.channel?.name!=='' ? messageContext?.messages?.channel?.name : "Select a channel to start chatting!" }</p>
    </div>
  )
}
